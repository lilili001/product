    ...
    <div class="row">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-danger btn-flat" href="{{ route('admin.product.category.index')}}"><i class="fa fa-times"></i> {{ trans('core::core.button.cancel') }}</a>
                    </div>
                </div>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                {!! Form::normalCheckbox('status', trans('product::categories.status'), $errors,$category) !!}
            </div>
        </div>
