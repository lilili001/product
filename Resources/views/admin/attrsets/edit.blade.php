...
@section('content-header')
    <h1>
        {{ trans('product::attrsets.title.edit attrset') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.product.attrset.index') }}">{{ trans('product::attrsets.title.attrsets') }}</a></li>
        <li class="active">{{ trans('product::attrsets.title.edit attrset') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.product.attrset.update', $attrset->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-10">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('product::admin.attrsets.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            {!! Form::label('key', 'Key:') !!}
                            {!! Form::text('key', old("key", $attrset->key), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <!---  Field --->
                        <div class="form-group">
                            ...
                            {!! Form::text('sort_order', old("sort_order", $attrset->sort_order), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
            </div>
